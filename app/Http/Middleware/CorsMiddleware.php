...
class CorsMiddleware
{
    ...
    public function handle($request, Closure $next)
    {
        $headers = [
            ...
            'Access-Control-Allow-Headers'     => 'Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers, admin-id,superadmin-id,event-org-id,order-mngt-id,overview-id,api-token, authorization',
