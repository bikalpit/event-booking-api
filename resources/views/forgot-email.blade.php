<html>
  ...
  <body class="email-template-main" style="background-color: #F3F3F3; margin: 0 auto; font-family: Poppins;">
    ...
    margin: 0 auto; margin-top: 30px; margin-bottom: 30px;">
      ...
      <a  style="background-color:#5AA4EF;color:white;padding:14px 25px;text-align:center;text-decoration: none;display: inline-block; "href="http://localhost/event-booking-api/api/reset-password?accessToken={{$token}}">Reset Password</a>
            <h2>Thank You!</h2>
      </div>
